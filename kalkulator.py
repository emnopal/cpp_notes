def main():
    ...
    #Pangkat
        ...
        a = float(input("a: "))
        b = float(input("b: "))
        Hasil = print(a , "pangkat", b , "adalah: ", pangkat(a,b))
    ...
    #About us
        ...
        print("Program ini dibuat oleh kelompok 3, Kelas A Semester 4")
        print("Dibuat untuk memenuhi tugas UAS (Ujian Akhir Semester) Fisika Komputasi")
        print("Program ini dibuat dengan menggunakan bahasa pemrograman Python")
        print("Anggota Kelompok: ")
        print("11170970000033 Muhammad Naufal")
        print("11170970000046 Muhammad Fariz")
        print("11170970000012 Selviera Intan")
        print("11170970000016 Ai Rahmi Fauziah")
        print("11170970000008 Luthfia Ikhwani")
